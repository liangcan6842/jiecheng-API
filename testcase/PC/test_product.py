...
def test_1_add_product_type(get_token_fixture):
    ...
    url = "http://192.168.110.173:9100/erp-admin-api/v1/category"
...
def test_2_add_product(get_token_fixture):
    ...
    url = "http://192.168.110.173:9100/erp-admin-api/v1/product"
    res = requests.post(url=url, headers=headers, json=data).text
    res = json.loads(res)
    print(res)
    assert res["code"] == 200
...
def test_4_print_product_code(get_token_fixture):
    ...
    url = "http://192.168.110.173:9100/erp-admin-api/v1/product/QR"
    res = requests.get(url=url, headers=headers, params=data).text
    res = json.loads(res)
    print(res)
    assert res["code"] == 200
